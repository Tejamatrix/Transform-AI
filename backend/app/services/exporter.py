...
def _to_pptx(content: dict) -> bytes:
    ...
    # Light theme â€” projector/print friendly, clean hierarchy
    ...
    def footer(slide, page_no):
        ...
        put(tf, "TransformAI", 9, MUTED, first=True)
    ...
    put(tf, "Generated by TransformAI â€” grounded in your source material", 14, MUTED, first=True)
...
def _pdf_story_blocks(content: dict) -> list:
    ...
    story: list = []
    title = content.get("title") or content.get("advisory_title") or content.get("deck_title") \
        or content.get("storyboard_title") or "TransformAI Output"
...
{chr(10).join(body)}
<div class="footer">Generated by TransformAI — grounded in your source material</div>
</body></html>"""
